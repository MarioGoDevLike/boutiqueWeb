...
$categoryImage = $row['category_picture'];
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0 text-dark">Update Category</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a class="text-dark" href="#">Home</a></li>
                                    <li class="breadcrumb-item active text-warning" aria-current="page">Update Category</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="d-flex justify-content-between" style="gap:3rem; margin-left:20px">
                        <div class="mb-3">
                            ...
                            <input value="<?php echo $categoryName ?>" type="text" autocomplete="off" name="categoryName" placeholder="Category Name" class="form-control" id="username" aria-describedby="usernameHelp">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-start" style="margin-left:20px;">
                        <button name="submit" type="submit" class="btn btn-warning d-flex justify-content-start">Update Category</button>
                    </div>
                </form>
            </div>
        </div>
