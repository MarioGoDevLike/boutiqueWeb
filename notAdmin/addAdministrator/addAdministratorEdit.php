            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0 text-dark">Update Administrator</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a class="text-dark" href="#">Home</a></li>
                                    <li class="breadcrumb-item active text-warning" aria-current="page">Update Administrator</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <form method="post">
                    <div class="d-flex justify-content-between">
                        <div class="mb-3">
                            ...
                            <input value="<?php echo $username ?>" type="text" autocomplete="off" name="username" placeholder="Enter your name" class="form-control" id="username" aria-describedby="usernameHelp">
                        </div>
