    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <div class="page-wrapper" style="min-height:100vh;">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0 text-dark">Add Administrator</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a class="text-dark" href="#">Home</a></li>
                                    <li class="breadcrumb-item active text-warning" aria-current="page">Add Administrator</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div style="padding: 20px;">
                <p style="width: 550px;"> Empower your team effortlessly with our Add Administrator page. Streamline user access, assign roles, and fortify your system's security. Elevate administrative control with a seamless platform designed for adding and managing privileged users.
                </p>
            </div>
            <div class="d-flex" style="justify-content:start;">
                <form method="post" action="addAdministrator_action.php">
                    <div class="d-flex justify-content-between" style="gap:3rem; margin-left:20px">

                        <div class="mb-3">
                            <label for="username" class="form-label">Username</label>
                            <input value="" type="text" autocomplete="off" name="userName" placeholder="Enter your name" class="form-control" id="username" aria-describedby="usernameHelp">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email address</label>
                            <input value="" type="email" autocomplete="off" name="email" class="form-control" id="email" aria-describedby="emailHelp">
                        </div>
                    </div>
                    <div class="d-flex justify-content-between" style="gap:3rem; margin-left:20px">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="" type="password" autocomplete="off" name="password" class="form-control" id="password">
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Confirm Password</label>
                            <input value="" type="password" autocomplete="off" name="confirmPassword" class="form-control" id="password">
                        </div>
                    </div>
                    <div class="d-flex justify-content-center">
                        <button name="submit" type="submit" class="btn btn-warning d-flex justify-content-center" style="width:15vw;">Add Administrator</button>
                    </div>
                </form>
            </div>
