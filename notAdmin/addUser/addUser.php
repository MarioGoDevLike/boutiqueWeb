    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <div class="page-wrapper" style="min-height:100vh;">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0 text-dark">Add User</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a class="text-dark" href="#">Home</a></li>
                                    <li class="breadcrumb-item active text-warning" aria-current="page">Add User</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <form method="post" action="addUser_action.php">
                    <div class="d-flex justify-content-between">
                        <div class="mb-3">
                            ...
                            <input value="" type="text" autocomplete="off" name="firstName" placeholder="Enter your name" class="form-control" id="username" aria-describedby="usernameHelp">
                        </div>
                        <div class="mb-3">
                            <label for="username" class="form-label">Last Name</label>
                            <input value="" type="text" autocomplete="off" name="lastName" placeholder="Enter your name" class="form-control" id="username" aria-describedby="usernameHelp">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email address</label>
                        <input value="" type="email" autocomplete="off" name="email" class="form-control input-styling" id="email" aria-describedby="emailHelp">
                    </div>
            ...
            <div class="d-flex justify-content-center">
                <button name="submit" type="submit" class="btn btn-warning d-flex justify-content-center">Add User</button>
            </div>
            </form>
        </div>
...
?>
<!-- Rest of your addUser.php content -->