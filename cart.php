        ...
        <div class="modal-content overflow-hidden border-0">
          ...
          <div class="modal-body p-0">
            <div class="row align-items-stretch">
              <div class="col-lg-6 p-lg-0"><a class="glightbox product-view d-block h-100 bg-cover bg-center" style="background: url(images/product-5.jpg)" href="images/template/product-5.jpg" data-gallery="gallery1" data-glightbox="Red digital smartwatch"></a><a class="glightbox d-none" href="images/template/product-5-alt-1.jpg" data-gallery="gallery1" data-glightbox="Red digital smartwatch"></a><a class="glightbox d-none" href="images/product-5-alt-2.jpg" data-gallery="gallery1" data-glightbox="Red digital smartwatch"></a></div>
              <div class="col-lg-6">
                      ...
                      <tr id="delete<?php echo $row['product_id'] ?>">
                        <th class="ps-0 py-3 border-light" scope="row">
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                              <strong class="h6">
                                <a class="reset-anchor animsition-link" href="detail.php"><?php echo $row['product_name'] ?></a>
                              </strong>
                            </div>
                          </div>
                        </th>
                        <td class="p-3 align-middle border-light">
                          <p class="mb-0 small"><?php echo $row['product_price'] ?>$</p>
                        </td>
                        <td class="p-3 align-middle border-light">
                        ...
                        <td class="p-3 align-middle border-light">
                          <p class="mb-0 small" id="product_price" value="<?php echo $row['product_price'] ?>"><?php echo $row['product_price'] ?>$</p>
                        </td>
                        <td class="p-3 align-middle border-light">
                          <a class="reset-anchor delete-product" href="#!" onclick="deleteProduct('<?php echo $row['product_id']; ?>')" data-product-id="<?php echo $row['product_id']; ?>">
            ...
            <div class="card border-0 rounded-0 p-lg-4 bg-light">
              <div class="card-body">
                ...
                <ul class="list-unstyled mb-0">
                  <li class="d-flex align-items-center justify-content-between"><strong class="text-uppercase small font-weight-bold">Subtotal</strong><span class="text-muted small" id="total-container"><?php echo $sum ?>$</span></li>
                  <li class="border-bottom my-2"></li>
                  <li class="d-flex align-items-center justify-content-between mb-4"><strong class="text-uppercase small font-weight-bold">Total</strong><span id="subtotal-container"><?php echo $sum ?>$</span></li>
                  <li>
                    <form action="#">
...
<script>
  function deleteProduct(productId) {
    $.ajax({
      type: "POST",
      url: "cartProducts/deleteProduct.php",
      data: {
        id: productId,
      },
