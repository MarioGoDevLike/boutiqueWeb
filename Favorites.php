                ...
                <div class="container p-0">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            ?>
                                    <div class="col-lg-4 col-sm-6" id="delete<?php echo $row['product_id'] ?>">
    ...
    height: 350px;"" class=" img-fluid w-100" src="notAdmin/addProduct/images/<?php echo $row['product_image']; ?>" alt="..."></a>
                                                <div class="product-overlay">
                                                    <ul class="mb-0 list-inline">
                                                        <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" onclick="deleteFavorite('<?php echo $row['product_id'] ?>')" href="#!"><i class="fa fa-window-close" aria-hidden="true"></i></a></li>
...
<script>
    ...
    function deleteFavorite(productId) {
        ...
        $.ajax({
            type: "POST",
            url: "cartProducts/deleteFavorite.php",
            data: {
                id: productId,
            },
            success: function(response) {
                $('#delete' + productId).hide();
                alert("This item is not your favorite anymore!");
